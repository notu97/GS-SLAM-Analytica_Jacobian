...
{	
  ...
  std::cout << "RasterizeGaussiansCUDA called with viewmatrix: " << viewmatrix << std::endl;
//   std::cout << "RasterizeGaussiansCUDA called with projmatrix: " << projmatrix << std::endl;
//   std::cout << "RasterizeGaussiansCUDA called with projmatrix_raw: " << projmatrix_raw << std::endl;
//   std::cout << "RasterizeGaussiansCUDA called with campos: " << campos << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with tan_fovx: " << tan_fovx << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with tan_fovy: " << tan_fovy << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with means3D: \n" << means3D << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with cov3D: \n" << cov3D_precomp << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with opacity: \n" << opacity << std::endl;
  std::cout << "RasterizeGaussiansCUDA called with projmatrix: " << projmatrix << std::endl;
