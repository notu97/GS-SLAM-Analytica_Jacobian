...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        # print("diff-gaussian-rasterization viewmatrix: ", raster_settings.viewmatrix)
        print("diff-gaussian-rasterization projmatrix: ", raster_settings.projmatrix)
        print("diff-gaussian-rasterization projmatrix_raw: ", raster_settings.projmatrix_raw)
        # print("diff-gaussian-rasterization campos: ", raster_settings.campos)
        # print("\n")
    ...
    def backward(ctx, grad_out_color, grad_out_radii, grad_out_depth, grad_out_opacity, grad_n_touched):
        ...
        print(" Backward starts here... ")
        print(" Backward means3D: ", means3D)
        ...
        print(" grad_tau (dL_dtau) :  ", grad_tau)
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, theta=None, rho=None):
        ...
        # print("gs_render forward: called with means3D shape:", means3D.shape)
